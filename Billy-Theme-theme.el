...
(custom-theme-set-faces
 'Billy-Theme
 '(default ((t (:inherit nil :stipple nil :background "#112222" :foreground "#999988" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight light :height 113 :width normal :foundry "PfEd" :family "DejaVu Sans Mono"))))
 ...
 '(font-lock-comment-delimiter-face ((t (:foreground "#6abd50" :weight bold))))
 '(font-lock-comment-face ((t (:slant italic :foreground "#DD9999" :background "#111111"))))
 '(font-lock-constant-face ((t (:foreground "#66DDEE"))))
 '(font-lock-doc-face ((t (:foreground "#CCBB22"))))
 '(font-lock-function-name-face ((t (:foreground "#cc3399"))))
 '(font-lock-keyword-face ((t (:foreground "#6699CC" :weight bold))))
 ...
 '(font-lock-regexp-grouping-construct ((t (:weight bold :foreground "#ff0000"))))
 '(font-lock-string-face ((t (:foreground "#77CC88"))))
 '(font-lock-type-face ((t (:foreground "#afd8af"))))
 ...
 '(mode-line-inactive ((t (:weight light :box (:line-width -1 :color "#4c83ff" :style nil) :foreground "#4D4D4D" :background "#1A1A1A"))))
 '(isearch ((t (:weight bold :foreground "#000000" :background "#cc3399"))))
 '(isearch-fail ((t (:foreground "#bdbdb3" :background "#8b0000"))))
